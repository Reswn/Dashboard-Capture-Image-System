...
<head>
  ...
  <title>Upload · Capture Panel</title>
  <link
    rel="icon"
    type="image/svg+xml"
    href="/favicon.svg"
...
<body>
  <div class="app">
    <aside class="sidebar">
      ...
      <nav class="nav">
        ...
        <a class="active" href="/test-upload">${iconUpload()} Upload</a>
    ...
    <main class="main">
      <header class="topbar">
        <div class="page-title">
          <h1>Upload</h1>
          <p>Upload manual untuk uji pengambilan citra.</p>
        </div>
        ...
        <div class="top-actions">
          ...
          <a class="btn btn-primary" href="/summary">${iconChart()} Summary</a>
        </div>
      </header>
      ...
      <section class="grid">
        <div class="panel">
          <div class="panel-head">
            <h2>Upload image</h2>
            <p>Pilih gambar, tentukan label, lalu simpan ke dataset.</p>
          </div>
          ...
          <form id="uploadForm">
            <div class="field">
              ...
              <input
                ...
                name="deviceKey"
                type="password"
                placeholder="x-device-key"
                required
              />
              <div class="hint">
                Mengikuti nilai <code>DEVICE_SECRET_KEY</code>.
              </div>
            </div>
            ...
            <div class="field">
              ...
              <select id="label" name="label">
                ...
                <option value="non_medis">non_medis</option>
            ...
            <div class="field">
              ...
              <input
                ...
                type="text"
                value="browser_test"
                placeholder="browser_test / esp32cam"
              />
            </div>
        ...
        <aside class="panel">
          <div class="panel-head">
            <h2>Preview</h2>
            <p>Status upload akan tampil di sini.</p>
          </div>
          ...
          <div class="preview-panel">
            ...
            <div class="upload-summary">
              <div class="summary-item">
                ...
                <strong id="selectedLabel">medis</strong>
              </div>

              <div class="summary-item">
                <span>Selected source</span>
                <strong id="selectedSource">browser_test</strong>
              </div>

              <div class="summary-item">
                <span>File name</span>
                <strong id="selectedFile">Belum ada file</strong>
              </div>
            </div>
          </div>
        </aside>
      ...
      <div class="footer-note">
        <span>Prototype backend · manual upload</span>
  ...
  <script>
    ...
    function updateSelectionInfo() {
      selectedLabel.textContent = labelInput.value;
      selectedSource.textContent = sourceInput.value || "browser_test";

      const file = imageInput.files?.[0];
      selectedFile.textContent = file ? file.name : "Belum ada file";
    }

    labelInput.addEventListener("change", updateSelectionInfo);
    sourceInput.addEventListener("input", updateSelectionInfo);
    ...
    imageInput.addEventListener("change", () => {
      ...
      if (!file) {
        previewBox.textContent = "Belum ada gambar dipilih.";
        return;
      }
      ...
      previewBox.innerHTML = \`
        <img src="\${imageUrl}" alt="Preview gambar upload" />
      \`;
    });
    ...
    form.addEventListener("submit", async (event) => {
      ...
      const source = sourceInput.value || "browser_test";
      const file = imageInput.files?.[0];

      if (!file) {
        statusBox.className = "status error";
        statusBox.textContent = "Pilih gambar terlebih dahulu.";
        return;
      }
      ...
      try {
        ...
        if (!response.ok || !data.success) {
          statusBox.className = "status error";
          statusBox.textContent = data.message || "Upload gagal. Periksa device key atau koneksi server.";
          return;
        }

        statusBox.className = "status success";
        statusBox.textContent = "Upload berhasil. Gambar sudah masuk ke dataset.";
      } catch (error) {
        statusBox.className = "status error";
        statusBox.textContent = "Upload gagal. Server tidak merespons.";
      } finally {
