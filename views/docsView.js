...
<head>
  ...
  <title>Guide · Capture Panel</title>
  ...
  <div class="app">
    <aside class="sidebar">
      ...
      <nav class="nav">
        ...
        <a class="active" href="/docs">${iconDocs()} Docs</a>
    ...
    <main class="main">
      <header class="topbar">
        <div class="page-title">
          <h1>Guide</h1>
          <p>Panduan singkat penggunaan sistem.</p>
        </div>
      ...
      <section class="hero">
        <div class="hero-card">
          <span>${iconDocs()} User guide</span>

          <h2>Panduan pengumpulan gambar untuk dataset.</h2>

          <p>
            Gunakan halaman ini sebagai acuan singkat sebelum mengambil, memberi label,
            dan mengunggah gambar ke sistem.
          </p>
        </div>

        <div class="quick-card">
          <h3>Target penggunaan</h3>
          <p>
            Membantu proses pengumpulan citra agar lebih rapi, konsisten, dan mudah diperiksa.
          </p>
        </div>
      </section>
      ...
      <section class="info-cards">
        <article class="info-card">
          <h3>Jenis gambar</h3>
          <p>Gunakan gambar JPG, JPEG, atau PNG dengan ukuran maksimal 5 MB.</p>
        </article>

        <article class="info-card">
          <h3>Label gambar</h3>
          <p>Pilih label yang sesuai saat gambar diunggah.</p>

          <div class="tag-row">
            <span class="tag">medis</span>
            <span class="tag">non_medis</span>
        ...
        <article class="info-card">
          <h3>Hasil upload</h3>
          <p>Gambar yang berhasil diunggah akan tampil pada dashboard, gallery, dan summary.</p>
        </article>
      </section>
      ...
      <section class="content-grid">
        <div class="panel">
          <div class="panel-head">
            ...
            <p>Urutan dasar saat mengumpulkan gambar.</p>
          </div>
          ...
          <div class="step-list">
            <div class="step">
              ...
              <div>
                <strong>Siapkan gambar</strong>
                <span>Ambil gambar dari kamera atau pilih file dari perangkat.</span>
              </div>
            </div>
            ...
            <div class="step">
              ...
              <div>
                <strong>Pilih label</strong>
                <span>Tentukan kategori gambar: medis, non_medis, atau unknown.</span>
              </div>
            </div>
            ...
            <div class="step">
              ...
              <div>
                ...
                <span>Kirim gambar melalui halaman upload.</span>
              </div>
            </div>
            ...
            <div class="step">
              ...
              <div>
                ...
                <span>Periksa gambar yang sudah masuk melalui dashboard, gallery, atau summary.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <aside class="panel">
          <div class="panel-head">
            <h2>Ketentuan gambar</h2>
            <p>Hal yang perlu diperhatikan saat mengambil gambar.</p>
          </div>

          <div class="note-list">
            <div class="note-item">
              Objek utama sebaiknya terlihat jelas dan tidak terlalu gelap.
            </div>

            <div class="note-item">
              Hindari gambar yang buram, terlalu jauh, atau terpotong ekstrem.
            </div>

            <div class="note-item">
              Gunakan label secara konsisten agar dataset tetap rapi.
            </div>

            <div class="note-item">
              Gunakan label unknown jika kategori gambar belum dapat dipastikan.
            </div>
          </div>
        </aside>
      </section>
      ...
      <div class="footer-note">
        <span>Prototype backend · guide</span>
